...
local SaveManager = {} do
    ...
    function SaveManager:BuildConfigSection(tab)
        ...
        local configs = Tabs["UI Settings"]:AddRightGroupbox("Configs")

        configs:AddInput("SaveManager_ConfigName",    { Text = "Config name" })
        configs:AddButton("Create config", function()
        ...
        configs:AddDropdown("SaveManager_ConfigList", { Text = "Config list", Values = self:RefreshConfigList(), AllowNull = true })
        ...
        configs:AddButton("Overwrite config", function()
            local name = self.Library.Options.SaveManager_ConfigList.Value
        ...
        configs:AddButton("Set as autoload", function()
            local name = self.Library.Options.SaveManager_ConfigList.Value
        ...
        configs:AddButton("Reset autoload", function()
        ...
        self.AutoloadLabel = configs:AddLabel("Current autoload config: " .. self:GetAutoloadConfig(), true)
